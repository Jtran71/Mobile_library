...
public class FinishedFragment extends Fragment {
    ...
    private void loadFinishedBooks() {
        booksRef.orderByChild("status").equalTo("finished")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        Toast.makeText(getContext(), "Failed to load finished books", Toast.LENGTH_SHORT).show();
                    }
                });
    }

    private void showBookDetailsDialog(Book book) {
        DialogUtils.showBookDetailsDialog(getContext(), book, booksRef, false, true, null);
    }
